...
import { DataJob } from "@/Pages/Admin/Jobs/data/Interface";

export default function JobCreate({ skills }) {
    const { data, setData, patch, errors } = useForm(DataJob);

    const submit = (e) => {
        e.preventDefault();
        patch(route("client.store.job"));
    };
    ...
    return (
        <form onSubmit={submit}>
            ...
            >
                <Head title="Client - Perusahaan Baru" />
