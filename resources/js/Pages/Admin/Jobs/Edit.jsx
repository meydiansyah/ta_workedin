...
export default function JobEdit({ job, companies, skills }) {
    const { data, setData, patch, errors } = useForm({
        ...{
            skill: job.skills.map((e) => {
                return e.id;
            }),
            pic_company_id: job.company.company_pic.id ?? null,
        },
        ...job,
    });
                        ...
                        <div className=" mx-auto max-w-3xl sm:px-6 items-start">
                            ...
                            >
                                {errors.pic_company_id && (
                                    <InputError message="*perusahaan belum memiliki penanggung jawab" />
                                )}
                                <div>
