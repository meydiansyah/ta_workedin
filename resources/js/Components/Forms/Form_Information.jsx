...
export function FormInformation({ title, data, setData, errors }) {
        ...
        >
            <div>
                <InputLabel
                    ...
                    value={
                        <div className="flex justify-between">
                            <span>NIK </span>
                            {data.nik.length === 16 && validate && (
                                <InputSuccess message="Data cocok" />
                            )}
                        </div>
                    }
                />
                ...
                <TextInput
                    ...
                    handleChange={(e) => {
                        ...
                        const _check = nikParser(e.target.value);
                        setValidate(_check.isValid());
                    }}
                    required
                    autofocus
                    autoComplete="nik"
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) => {
                        setData("profile_photo_url", e.target.files[0]);
                    }}
                    autoComplete="photo"
                />
